...
2. **Refresh the project:** In the History workbench, click <img src="/HistoryWorkbench/icons/RefreshRepository.svg" width="16" alt="" style="display:inline-block; vertical-align:text-bottom; margin:0 0.25em;" /> **Refresh Project** so the history list and document status reflect the latest files.
...
5. **Open 3D comparisons:** For changed Part, PartDesign, or Sketcher objects, click <img src="/HistoryWorkbench/icons/VisualDiff.svg" width="16" alt="" style="display:inline-block; vertical-align:text-bottom; margin:0 0.25em;" /> **3D Comparison** next to the object to open a separate comparison document. Removed material is shown in red, added material in green, and unchanged material in gray. You may use FreeCAD's unified measurement tool to measure changes.
...
9. **Save an iteration:** Click <img src="/HistoryWorkbench/icons/Commit.svg" width="16" alt="" style="display:inline-block; vertical-align:text-bottom; margin:0 0.25em;" /> **Save Iteration**, enter a description of the changes, and confirm.
