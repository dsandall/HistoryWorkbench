...
- **Initialize your project:** open a FreeCAD folder you want to designate as your project, then click <img src="/HistoryWorkbench/icons/CreateGitRepository.svg" width="16" alt="" class="command-icon" /> **Initialize Project**.
...
- **Save an iteration:** go to Reviewed Area to do a final check. Click <img src="/HistoryWorkbench/icons/Commit.svg" width="16" alt="" class="command-icon" /> **Save Iteration** to finalize an iteration using the reviewed files.
