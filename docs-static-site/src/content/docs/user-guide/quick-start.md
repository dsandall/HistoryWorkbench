...
- **Initialize your project:** open a FreeCAD folder you want to designate as your project, then click <img src="/HistoryWorkbench/icons/CreateGitRepository.svg" width="16" alt="" style="display:inline-block; vertical-align:text-bottom; margin:0 0.25em;" /> **Initialize Project**.
...
- **Save an iteration:** go to Reviewed to do a final check. Click <img src="/HistoryWorkbench/icons/Commit.svg" width="16" alt="" style="display:inline-block; vertical-align:text-bottom; margin:0 0.25em;" /> **Save Iteration** to finalize an iteration using the reviewed files.
