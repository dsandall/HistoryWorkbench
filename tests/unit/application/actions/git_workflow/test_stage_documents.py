...
class TestStageDocumentsAction:
    ...
    def test_matching_open_doc_always_calls_save_document(self) -> None:
        ...
        with (
            patch("freecad.history_wb.application.actions.git_workflow.stage_documents.SnapshotYamlSerializer"),
    ...
    def test_deleted_path_with_open_doc_logs_warning_and_does_not_save(self) -> None:
        ...
        with (
            ...
            patch("freecad.history_wb.application.actions.git_workflow.stage_documents.Log.warning") as warning_mock,
        ):
            result = action.execute(repo, [], deleted_paths=["deleted.FCStd"])
    ...
    def test_snapshot_and_deleted_overlap_returns_failure_before_side_effects(self) -> None:
        ...
        with (
            patch("freecad.history_wb.application.actions.git_workflow.stage_documents.SnapshotYamlSerializer") as serializer_mock,
