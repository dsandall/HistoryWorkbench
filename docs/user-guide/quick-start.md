...
- **Initialize your project:** open a FreeCAD folder you want to designate as your project, run the "Initialize Project" command
...
- **Save an iteration:** go to Reviewed to do a final check. Click Save Iteration to finalize an iteration using the reviewed files.
